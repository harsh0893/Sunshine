...
//
        locationRowId = TestUtilities.insertNorthPoleLocationValues(this.mContext);
...
//         Finally, close the cursor and database
    ...
    public void testWeatherTable() {
        ...
        SQLiteDatabase db = new WeatherDbHelper(this.mContext).getWritableDatabase();
//
        long weatherRowId = TestUtilities.insertWeatherValues(this.mContext,locationRowId);
